...
// BrowserMeshClient talks to a BrowserMesh control plane.
type BrowserMeshClient struct {
	baseURL string
	apiKey  string
	http    *http.Client
}

// NewBrowserMeshClient builds a client. Both the base URL and the API key are required.
//
//	baseURL: e.g. "http://127.0.0.1:30080"
//	apiKey:  a key created in the dashboard, e.g. "bmsk_..."
func NewBrowserMeshClient(baseURL, apiKey string) (*BrowserMeshClient, error) {
...
func (c *BrowserMeshClient) do(ctx context.Context, method, path string, body, out any) error {
	var rdr io.Reader
	if body != nil {
